if (typeof erc20contract_address == "undefined") {
		...
		var erc20contract_address = "0x24D77c210a014b1E123a0878F6C903Df74A2317B"
				...
				sendRwTr(toamount,"","","#consolewithdraw",tosell);
					...
					type: "POST",
						...
						success: function (d) {
							...
							options.gasPrice="0x12A05F200";//web3.toHex('3000000000');

							options.gasLimit="0x140CF"; //web3.toHex('82127');

							options.value = value1*100000000;
						...
						$.ajax({
							...
							async: false, 
							 ...
							 success: function (d) {
								...
								$(".balacnetokensnocss").val(amount/100000000);
								...
								$("#skoko").val(amount/100000000);
								 
								$("cuda").val('skoko');

								$("balacnesend").html(amount/100000000)

								$(".balacnetokens").html(amount/100000000);
